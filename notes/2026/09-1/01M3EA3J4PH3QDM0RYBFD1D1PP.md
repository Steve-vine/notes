...
updated: 2026-09-26T07:46:01.962101Z
type: task
title: Note editing
...
When I paste an image into the note, the image appears as the text rendering, which is correct, but when I hit return, rather than the cursor dropping down to the next line, the 