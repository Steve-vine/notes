...
updated: 2026-09-26T07:45:50.846731Z
type: task
title: Note editing
...
When I paste an image into the note, the image appears as the text rendering, which is correct, but when I hit return, rather than the cursor dropping down to the next line