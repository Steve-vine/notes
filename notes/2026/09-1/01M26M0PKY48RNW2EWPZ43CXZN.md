...
updated: 2026-09-10T21:36:40.062719Z
type: task
...
* **Snapshot at trigger**: the combined holder list (COM-… holders task) — group holders resolved through nested expansion plus manual holders — one row per holder with its source frozen. Owners attest in the portal's existing **Recertifications** tab; nothing new to learn.
