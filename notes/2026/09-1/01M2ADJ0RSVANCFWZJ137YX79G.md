...
updated: 2026-09-12T09:00:45.209261Z
type: task
...
* **Licences used** and **Deployed on** — derived, from the follow-on task; this task returns `licences_used: 0` and `deployed_on: []` so the shapes are stable.
