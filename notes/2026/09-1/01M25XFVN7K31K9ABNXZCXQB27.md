...
updated: 2026-09-10T15:02:59.495308Z
type: task
...
- Vendor Portal **on**, at `vendor-portal.moneypenny.uk`, reached through a Cloudflare Tunnel — that route is COM-657 and blocks the portal going live, not the install: the employee app can be installed with `vendorPortal.ingress.enabled: false` and the portal switched on when the tunnel exists.
