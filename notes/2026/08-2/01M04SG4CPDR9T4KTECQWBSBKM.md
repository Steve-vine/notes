...
updated: 2026-08-16T08:09:50.757965Z
type: task
...
- [ ] New tab/route **My Vendors** in the portal shell nav; table = vendors where `owner_id == me`, same columns as the Vendors register (State / Compliance / Criticality / Flags) incl. engagement sub-rows (COM-212 layout + COM-217 row colouring).
...
- [ ] Tests: owner filter under portal auth (403 unchanged elsewhere), tab renders owned vendors only, My requests untouched, tab labels + order updated.
