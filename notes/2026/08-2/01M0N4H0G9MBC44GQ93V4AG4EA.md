...
updated: 2026-08-22T16:23:10.089714Z
type: task
...
number: 363
---
Decided 2026-08-22, completing the compliance model (COM-360's ADR):
...
- [ ] **`dormant → active` (reactivation) sets `compliance_status = not_assessed`.** Coming back means being assessed again — matches ADR 0039's "re-activation re-triggers review" intent and COM-360's earned-compliance rule. The prior status is not restored; it aged exactly as long as the vendor sat dormant.
