...
updated: 2026-08-16T11:29:46.224441Z
type: task
...
2. **Graph's simple sendMail caps attachments at ~3MB.** Above that it needs an upload session, which is out of scope — this is the number that sets the report-attachment cap in [ISE-746].
