...
updated: 2026-08-09T13:55:24.041989Z
type: task
...
- **Portal detail scope** — lifecycle, details, assurance profile, certifications, flags, engagements, review history, revision history. **Excluded** as internal working data: vendor assessments (questionnaire answers), linked risks (the risk register), review actions (the Actions queue). A per-endpoint decision, easy to widen later.

**Two departures the ADR must state explicitly:**
