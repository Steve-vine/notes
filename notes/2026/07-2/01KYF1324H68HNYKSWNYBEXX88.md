...
updated: 2026-07-26T10:57:34.855953Z
type: task
...
**Files:** new `migrations/*_0059_managed_webhook_source.py`, `tests/integration/test_github_events.py`; mod `models.py`, `webhooks.py`, `tasks/repos.py`, `connectors/github.py` (releases fetch), `api/v1/webhook_sources_api.py` (read-only guard for managed), `SettingsPage.tsx` (webhook sources card), OpenAPI regen.

**Migration chain:** 0059 is last — stacks after 0058; coordinate revision ids with the retrieval branch.