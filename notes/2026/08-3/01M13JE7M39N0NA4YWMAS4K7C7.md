...
## Kubernetes depth — other standout
- Six self-managed bare-metal clusters, 6 yrs zero downtime. Hardest production incident — diagnosis + permanent fix.
- Bare-metal/self-managed is a different discipline from managed EKS/AKS. How does it translate to managed-control-plane, and what do managed clusters make people forget?
