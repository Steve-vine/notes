...
updated: 2026-08-09T13:55:24.043404Z
type: project
title: Compass
identifier: COM
next_task_number: 192
sprints:
- id: s8ayp7w
...
- id: sw3i5is
  title: Vendor Portal
  description: Add a vendor portal that can be used by all employees to view vendor information and request the addition of new vendors and new vendor engagements.
assignee: steve
priority: medium
