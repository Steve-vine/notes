...
updated: 2026-08-09T13:26:58.832583Z
type: project
title: Compass
identifier: COM
...
- id: sw3i5is
  title: Vendor Portal
  description: 'Add an external facing vendor portal that doesn’t require authentication, that can be used by all employees to view vendor information and request the addition of new vendors '
assignee: steve
priority: medium
