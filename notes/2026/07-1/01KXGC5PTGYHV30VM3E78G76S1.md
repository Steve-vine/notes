...
updated: 2026-08-09T13:26:42.217862Z
type: project
title: Compass
identifier: COM
...
- id: sw3i5is
  title: Vendor Portal
  description: 'Add an external facing vendor portal that doesn’t require authentication, that can be used by all employees to view vendor information '
assignee: steve
priority: medium
