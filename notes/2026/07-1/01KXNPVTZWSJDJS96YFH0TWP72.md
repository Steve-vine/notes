...
updated: 2026-07-16T18:35:50.084403Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
Analyse - This determines the current state, initially triggered by the error detection itself, but there should be an Analyse button that queries if that state still exists
D
