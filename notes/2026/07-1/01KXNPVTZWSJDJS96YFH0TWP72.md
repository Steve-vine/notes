...
updated: 2026-07-16T18:38:25.098709Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
Diagnose - Existing button, examines the issue, and if it has access to the affected infrastructure (such as k8s cluster, accesses it to collect additional relavant info.
