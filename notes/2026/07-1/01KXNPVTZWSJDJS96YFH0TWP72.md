...
updated: 2026-07-16T18:43:35.917073Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
**Propose** - Existing Propose remediation button, as today, where is can propose an actionable change, this should be resented 
