...
updated: 2026-07-16T18:35:33.434808Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
Analyse - This determines the current state, initially triggered by the error detection itself, but there should be an Analyse button 
D
