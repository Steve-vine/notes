...
updated: 2026-07-16T14:56:33.788667Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
number: 88
---
In this sprint, create a set of tasks that will implement the full process for dealing with issues via the UI within the Issues screen.

### Screen configuration
#### Top section
The screen should be configured with the issue details at the top, this includes the Issue ID, assignee, status and tags.
