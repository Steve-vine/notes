...
updated: 2026-07-16T18:24:51.924606Z
type: task
title: Issue Loop
assignee: steve
priority: medium
...
#### Top section
The screen should be configured with the issue details at the top, this includes the Issue ID, Title and tags, as it is today, but move the status to the far right. The “raised by" line and the assignee. 
